...
import { doSignOut, getManagersForHome } from "@/app/services/api/api";
...
import { Button, Col, Modal, Row, Container, Dropdown, TabContent } from "react-bootstrap";
import GeoInfoAgGridButton from "./components/actions/GeoInfoAgGridButton";
import { CSSTransition } from "react-transition-group";
import ReactSwitch from "react-switch";
import ReportGridBtn from "./components/actions/ReportGridBtn";
import Report from "./components/report-manager/Report";
...
const Home = () => {
  ...
  const [modalAvatarPhoto, setModalAvatarPhoto] = useState(null);
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {
      headerName: "ثبت گزارش",
      field: "report",
      minWidth: 150,
      width: 150,
      sortable: false,
      filter: false,
      cellRenderer: memo(ReportGridBtn),
    ...
    },
    {
      ...
      field: "publicResidenceCoordinate",
      hide: true,
      sortable: false,
      filter: false,
    },
  ...
  const onGridReady = useCallback(async () => {
    try {
      const response = await getManagersForHome();
              ...
              <Dropdown show={isOpen} onToggle={toggleMenu}>
                ...
                >
                  ...
                  localStorage.getItem("token") ? (
                    ...
                    <>
                      <Dropdown.Item href="/auth/register">
                        ثبت نام
                      </Dropdown.Item>
                ...
                >
                  <div className="col-xl-12 d-flex  mb-4">
                    <div className="card m-card shadow-lg border-0 flex-fill">
                      ...
                      <div className="card-body p-0" style={{ height: 800 }}>
                        <PieChartJs
                          gridData={memoizedData}
                          labelKey="organName"
                          valueKey="percentage"
                    ...
                    <div className="card m-card shadow-lg p-0 m-0">
                      ...
                      <div className="card-body p-0 m-0">
                        ...
                        >
                          <ManagersClusterMap
                            gridData={memoizedData}
                            whichCoord={"publicResidenceCoordinate"}
                            heightx={"27rem"}
                          />
                        </div>
                      </div>
