...
import AddManagerAsAdmin from "../components/add-manager/AddManagerAsAdmin";
import Loadingx from "../components/ui/Loadingx";
import Select from "react-select";
import SelectTagsx from "../components/select-tags/SelectTagsx";
...
const Home = () => {
  ...
  const selectsToShow = [
    { label: "نام دستگاه", value: "organNameOptions", id: 1 },
    { label: "نوع پست سازمانی", value: "organResTypeOptions", id: 2 },
    { label: "عنوان پست سازمانی", value: "organResNameOptions", id: 3 },
    { label: "واحد سازمانی", value: "organUnitOptions", id: 4 },
    { label: "نوع مدیر حرفه ای", value: "managerLevelOptions", id: 5 },
    { label: "نوع استخدام", value: "employTypeOptions", id: 6 },
  ];

  const [selectedSelect, setSelectedSelect] = useState([]);

  const [selectsCollapse, setSelectsCollapse] = useState(true);
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {
      headerName: "مدیر دستگاه است؟",
      field: "isOrganManager",
  ...
  const onGridReady = useCallback(async () => {
    try {
      const response = await getManagersForAdmin();
            ...
            <div className="container-fluid">
              ...
              <div className="row mt-4">
                ...
                <CSSTransition
                  ...
                  unmountOnExit
                >
                  <div className="col-xl-12 mb-5 px-5">
                    <div className="card m-card shadow-lg p-0 m-0">
                      <div className="card-header bg-white">
                        <h5
                          className="card-title"
                ...
                <div className="col-xl-12 mb-1 mt-4">
                  <Button
                    variant="outline-primary"
                    type="button"
                    onClick={() => {
                      setSelectsCollapse((e) => !e);
                      setSelectedSelect("");
                    }}
                    size="lg"
                    className="mx-1"
                  >
                    {selectsCollapse ? (
                      ...
                      <span>ثبت مقادیر انتخابی جدید</span>
                    )}
                  </Button>
                  <CSSTransition
                    in={selectsCollapse}
                  ...
                  >
                    <div className="col-xl-12 mt-2">
                      <div className="card m-card shadow-lg border-2 p-0 m-0">
                        <div className="card-header bg-white">
                          <h5 className="card-title">
                            ویرایش یا ثبت مقدار انتخابی جدید
                          </h5>
                        </div>

                        <div className="card-body mt-3 mb-3">
                          <div className="col-xl-2  mx-1">
                            <Select
                              options={selectsToShow}
                          ...
                          <SelectTagsx
                            selectTags={selectObjs[selectedSelect["value"]]}
                            selectTypeId={selectedSelect["id"]}
                            updateSels={getSelectObjectsFromServer}
                          />
                        </div>
                      </div>
                    </div>
      ...
      >
        ...
        <Modal.Body>
          <Container>
            <Row>
              <Col xs={12} md={12}>
                <DocShow managerId={selectedManagerId} admin={"admin"} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
      ...
      >
        ...
        <Modal.Body>
          <Container>
            <Row>
              <Col xs={12} md={12}>
                <ReportsShow managerId={selectedManagerId} admin={"admin"} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
